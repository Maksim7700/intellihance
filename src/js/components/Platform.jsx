      ...
      <div className='platform'>
        ...
        <div className='market'>
            ...
            <div className='market-information'>
              <div className='inside-market-information'>
                ...
                <div className='market-box'>
                  ...
                  <div className='market-desc Montserrat-500'>Intellihance™ identifies your needs with three easy steps:<br/>
            ...
            <div className='market-information'>
              <div className='inside-market-information'>
                ...
                <div className='market-box'>
                  ...
                  <div className='market-desc Montserrat-500'>Whether you’re looking to assess business opportunities, understand the latest industry trends, or enrich your marketing strategy, Intellihance™ can deliver accurate and instant results.</div>
                </div>
              </div>
            </div>
            <div className='market-information'>
              <div className='inside-market-information'>
                ...
                <div className='market-box'>
                  ...
                  <div className='market-desc Montserrat-500'>Access your reports in downloadable formats PDF Excel from the convenience of your Intellihance™ dashboard.</div>
                </div>
              </div>
            </div>
          </div>
          <div className='video-box'>
            <div className='video'>
              <embed height={314} width={522} src="https://www.youtube.com/embed/zC4rZpHf8tw?controls=1&amp;rel=0&amp;playsinline=0&amp;modestbranding=1&amp;autoplay=0&amp;enablejsapi=1&amp;origin=https%3A%2F%2Fideaconsult.biz&amp;widgetid=1"></embed>
